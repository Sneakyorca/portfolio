          ...
          <div className="p-10">
            ...
            <div className="project-stack flex justify-between items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href={project.repo}
                  className="inline-block p-2.5 rounded-full bg-secondary opacity-100 translate-x-0 lg:opacity-0 lg:-translate-x-3 lg:group-hover:translate-0 lg:group-hover:opacity-100 lg:group-active:translate-0 lg:group-active:opacity-100 transition-all duration-300"
                  target="_blank"
                >
                  <svg
